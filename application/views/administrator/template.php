...
<html>
  <head>
    ...
    <title>SELAMAT DATANG DI ADMINISTRATOR</title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div class='alert alert-warning alert-dismissible fade in' role='alert' style='border-radius:0px; margin-bottom:0px'>
          ...
          <a href="http://www.lokomedia.web.id/" style="margin-right:10px; text-decoration:none;">Haloo Selamat datang di halaman administrator, Saat ini anda menggunakan WEBSITE KOMSUS. Silahkan Hubungi Developer</a>
          <a target='_BLANK' class="btn btn-default btn-sm" href="http://ahmadnuripa.rf.gd/" style="color: rgb(243, 156, 18);">AHMAD NURIPA</a>
        </div>
      <?php } ?>
